...
This is my first time putting a list like this together. Even if something gets on here, do your due dilligence to ensure that you aren't getting screwed out of your hard earned money. DO YOUR OWN RESEARCH!!! Also, while investing in yourself is important, don't spend money you don't have!  
 ...
 - Deals are publically announced and sourced from emails, social media, and checking some of my favorite websites. 
 ...
 Gear I have used is marked with ✨
...
| **White Knight Labs** 💖 | https://training.whiteknightlabs.com/ | 50% off ``WKLBLACKFRIDAY50`` | Offensive focus **ENDS 12/12/2025** |
| **Altered Security** 💖 | https://www.alteredsecurity.com/ | Up to 20% off Bootcamps | Offensive focus **Ends 12/17/2025** | 
| **Trainsec** | https://trainsec.net/cybersecurity-courses-black-friday-2025 | 40% off individual courses | Security and Developer focused **Ends 12/1/2025** | 
...
| Organization | URL | Discount Details | Notes |
| --- | --- | --- | --- |
| **HTB Cyber Pro Labs** | https://www.hackthebox.com/blog/New-pro-labs-discount 25% discount ``novprolabsannual25off`` | |  
...
| Organization | URL | Discount Details | Notes |
| --- | --- | --- | --- |
| **ProtonMail** ✨ | https://proton.me/mail/black-friday#pricing | 50% off annual subscription | |
| **Tiny Sheild** | https://tinyshield.proxyman.com/pricing | 60% off | Firewall for Mac |  
| **Namecheap** | https://www.namecheap.com/domain-web-hosting-ssl-deals/black-friday/ | Up to 99% off | Buy a domain for that project you probably won't start (I've never done this, I promise) | 
